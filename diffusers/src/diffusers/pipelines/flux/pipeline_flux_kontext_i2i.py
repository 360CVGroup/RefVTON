...
class FluxKontextPipelineI2I(
    ...
    def _pack_latents(latents, batch_size, num_channels_latents, height, width):
        ...
        # print(height, width, latents.shape, "_pack_latents")
    ...
    def _encode_vae_image(
        ...
        for i, key in enumerate(key_to_index_scale.keys()):
            image_latent = image[key].to(device=device, dtype=dtype)
            # print(image_latent.shape, key)
            ...
            # print(image_idx[..., 1], key)
            # print(image_idx[..., 2], key)
            # print(image_latent.shape, image_idx.shape)
    ...
    def prepare_latents(
        ...
        # print(latents.shape, image_latents.shape, "latent.shape", "image_latents.shape")
    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                # self.visualize(latents, height, width, output_type, t)
